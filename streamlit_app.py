...
# 💂️ Load Dataset
df = pd.read_csv("https://raw.githubusercontent.com/NathanBrunet/ML-Project-Diabetes-Prediction/refs/heads/main/TAIPEI_diabetes%20(1).csv?token=GHSAT0AAAAAAC76KYIJGIWBAIZVJMHJWTHSZ64HBVQ")
